                    ...
                    <form action="{{route('admin.menu.update', $menu->id)}}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{$menu->link}}">
                                @error('link')
                                <div class="valid-feedback">{{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="idparent" class="form-control select2-single select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                    ...
                                    <optgroup label="انتخاب والد منو">
                                        ...
                                        <option <?php if($menu->idparent==$menu_id) echo "selected"; ?>
                                         value="{{$menu_id}}">{{$menu_title}}</option>
                                        @endforeach
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('order') is-invalid @enderror" name="order" value="{{$menu->order}}">
                                @error('order')
                                <div class="valid-feedback">{{$message}}
                                </div>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="active">
                                    ...
                                    <option value="0" <?php if($menu->active==0) echo "selected"; ?>>غیرفعال</option>
                                </select>
